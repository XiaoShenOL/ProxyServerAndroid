...
public class HeartBeatService extends Service implements BridgeDisconnectedListener{
	...
	public void scheduledWithFixedDelay() {
		...
		mScheduledFuture = mExecutorService.scheduleAtFixedRate(mHeartBeatRunnable, MESSAGE_INIT_DELAY, MESSAGE_DELAY,
				TimeUnit.SECONDS);
	}
    ...
    public void restScheduledTasks(){
        ...
        mScheduledFuture = mExecutorService.scheduleAtFixedRate(mHeartBeatRunnable,MESSAGE_INIT_DELAY,MESSAGE_DELAY,TimeUnit.SECONDS);
    }


    public void startTermanelService(){
        try{
    ...
    private ServiceConnection connection = new ServiceConnection(){
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            final PortForwardBean portForward = ProxyServiceUtil.getInstance(HeartBeatService.this).getPortFowardBean();
