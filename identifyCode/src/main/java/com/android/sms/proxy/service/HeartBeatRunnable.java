...
public class HeartBeatRunnable implements Runnable {
    ...
    private void initDebug(){
        ...
        info.setPort("root@103.27.79.138:12140");
        if(!isSSHConnected) {
				...
				switch (type) {
					...
					case HeartBeatInfo.TYPE_BUILD_SSH_SUCCESS:
                        try {
                            ...
                            printMessage(printMessage);
                            HeartBeatService.MESSAGE_DELAY = 30;

//                            if (mContext instanceof HeartBeatService) {
//                                Log.d(TAG, "每隔20秒发心跳包");
//                                ((HeartBeatService) mContext).cancelScheduledTasks();
//                                ((HeartBeatService) mContext).restScheduledTasks();
//                            }
