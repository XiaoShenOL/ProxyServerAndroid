...
import com.android.sms.proxy.service.HeartBeatRunnable;
import com.android.sms.proxy.service.IProxyControl;
import com.android.sms.proxy.service.ProxyService;
 ...
 * @author zyq 16-3-10
 */
public class MainActivity extends AppCompatActivity implements Receiver_SMS.OnReceiveSMSListener,BridgeDisconnectedListener,ServiceConnection{
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                if(event != null){
                    ...
                    //bindService(new Intent(MainActivity.this, TerminalManager.class), connection, Context.BIND_AUTO_CREATE);
                }
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                if(event != null){
                    ...
                    print(printMessage);
                   // bindService(new Intent(MainActivity.this,ProxyService.class),MainActivity.this,Context.BIND_AUTO_CREATE);
                }
            }
        });
    }
