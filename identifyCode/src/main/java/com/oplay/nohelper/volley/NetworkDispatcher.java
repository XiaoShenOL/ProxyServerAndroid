 ...
 * specified {@link com.oplay.nohelper.volley.Network} interface. Responses are committed to cache, if
 * eligible, using a specified {@link com.oplay.nohelper.volley.Cache} interface. Valid responses and
 * errors are posted back to the caller via a {@link com.oplay.nohelper.volley.ResponseDelivery}.
 */
