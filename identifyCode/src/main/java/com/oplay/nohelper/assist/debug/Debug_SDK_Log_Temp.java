package com.oplay.nohelper.assist.debug;

import android.util.Log;

public class Debug_SDK_Log_Temp extends Debug_SDK_Log {

	public static String mTag = createDefaultTag();// YoumiLib
	...
	public static void dd(String tag, Object... args) {
		if (isDebug) {
			printDebugInfo(Log.DEBUG, tag, null, "%s", args);
		}
	}
