...
public abstract class Request<T> implements Comparable<Request<T>> {
	...
	/**
	 * Creates a new request with the given method (one of the values from {@link Request
	 * .Method}),
	...
	/**
	 * Return the method for this request.  Can be one of the values in {@link Request
	 * .Method}.
	 */
	...
	/**
	 * Returns the {@link Priority} of this request; {@link com.oplay.nohelper
	 * .volley.Request
