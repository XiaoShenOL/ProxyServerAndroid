...
public class AppDownloadManager {
	...
	private static  boolean isSilentInstall;
				...
				if (task != null) {
					switch (status) {
						...
						case DownloadManager.STATUS_SUCCESSFUL:
							...
							// 成功只需要响应一次
							startInstallLogic(appModel,isSilentInstall);
							break;
	...
	private void startInstallLogic(final AppModel model, final boolean isSlient) {
