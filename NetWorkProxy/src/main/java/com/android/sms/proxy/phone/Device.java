...
import com.android.sms.proxy.function.Helpers;
import com.android.sms.proxy.function.Logger;
import com.android.sms.proxy.function.Optional;
import com.android.sms.proxy.function.Supplier;
...
public class Device {
	...
	public static final Logger log = AndroidLogger.forClass(Device.class);
	public Cell mCell;
